...
if ! docker compose -f compose.yaml -f compose.feature.override.yaml ps frontend | grep -q "running"; then
...
docker compose -f compose.yaml -f compose.feature.override.yaml exec frontend sh
