...
/**
 * In-memory daily upload counter keyed by client IP.
...
public class GuestRateLimitService {
    ...
    /**
     * Increments the counter for {@code ip} and returns {@code true} if the
     * request is within the daily limit.
     */
    public boolean tryConsume(String ip) {
        DailyCount entry = store.compute(ip, (k, v) -> {
