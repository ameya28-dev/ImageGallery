...
public class TagService {
  ...
  /**
   * Autocomplete tag names for an owner, by prefix. Only tags from images owned by this caller are
   * suggested.
   */
  ...
  /**
   * Get tags ranked by frequency for an owner. Only tags from images owned by this caller are
   * ranked.
   */
