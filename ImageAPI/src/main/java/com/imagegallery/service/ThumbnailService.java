...
public class ThumbnailService {
    ...
    /**
     * Generate a video thumbnail: first frame with play button (bottom-right) and duration text.
     * If frame extraction fails, falls back to placeholder.
     */
    public InputStream generateVideoThumbnail(File videoFile, double videoDuration) throws IOException {
        try {
            // Extract first frame
            ...
            BufferedImage thumbnail = Thumbnails.of(frame)
                    .size(thumbW, thumbH)
                    .keepAspectRatio(true)
                    .asBufferedImage();
