...
/**
 * Resolves the numeric user ID of the current request's owner scope. Empty for anonymous/guest
 * requests → owner scope is NULL (the public seed pool). Non-empty for authenticated requests →
 * owner scope is that user's ID.
 */
@Component
