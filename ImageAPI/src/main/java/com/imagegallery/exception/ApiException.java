...
/**
 * Represents an error from an external API call (e.g., Anthropic Vision API). Includes error type
 * categorization for granular frontend handling.
 */
public class ApiException extends RuntimeException {
  ...
  /**
   * Factory method: builds an ApiException from an ErrorType, with appropriate HTTP status and
