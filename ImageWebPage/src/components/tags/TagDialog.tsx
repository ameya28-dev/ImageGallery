...
export default function TagDialog({
  ...
  return (
    <>
      ...
      {open && autocomplete.length > 0 && inputRef.current && createPortal(
        <div
          className="fixed z-[70] bg-neutral-800 rounded-xl overflow-y-auto max-h-48 shadow-lg"
          style={{
        ...
        >
          {autocomplete.map((tag) => (
            <button
              ...
              className="w-full text-left px-4 py-2.5 text-sm text-gray-200 hover:bg-white/10 flex items-center gap-2 truncate whitespace-nowrap"
            >
